<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="campus_name" prop="campusName">
        <el-input
          v-model="queryParams.campusName"
          placeholder="请输入campus_name"
          clearable
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Plus"
          @click="handleAdd"
          v-hasPermi="['function:fun_campusInfo:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['function:fun_campusInfo:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['function:fun_campusInfo:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['function:fun_campusInfo:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="fun_campusInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="campus_id" align="center" prop="campusId" />
      <el-table-column label="campus_name" align="center" prop="campusName" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['function:fun_campusInfo:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['function:fun_campusInfo:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="fun_campusInfoRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="campus_name" prop="campusName">
          <el-input v-model="form.campusName" placeholder="请输入campus_name" />
        </el-form-item>
        ...
        <el-table :data="gradeInfoList" :row-class-name="rowGradeInfoIndex" @selection-change="handleGradeInfoSelectionChange" ref="gradeInfo">
          ...
          <el-table-column label="grade_name" prop="gradeName" width="150">
            <template #default="scope">
              <el-input v-model="scope.row.gradeName" placeholder="请输入grade_name" />
            </template>
          </el-table-column>
        </el-table>
      </el-form>
...
import { listFun_campusInfo, getFun_campusInfo, delFun_campusInfo, addFun_campusInfo, updateFun_campusInfo } from "@/api/function/fun_campusInfo";
...
const data = reactive({
  ...
  rules: {
    campusName: [
      { required: true, message: "campus_name不能为空", trigger: "blur" }
    ]
  }
});
...
function handleExport() {
  proxy.download('function/fun_campusInfo/export', {
    ...queryParams.value
